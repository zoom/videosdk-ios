...
@return If the function succeeds, it returns an array of ZoomVideoSDKSubSessionUser. Otherwise returns NULL. For more details, see \link ZoomVideoSDKSubSessionUser \endlink.
*/
