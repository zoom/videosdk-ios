 ...
 * @return An object of type \link ZoomVideoSDKVirtualBackgroundItem \endlink. Once the function is called successfully, this parameter will store the pointer to the ZoomVideoSDKVirtualBackgroundItem*.
 */
...
/**
 * @brief Returns a collection of virtual background item as an object.
 ...
 * @return If the function succeeds, it will return the object.
 */
